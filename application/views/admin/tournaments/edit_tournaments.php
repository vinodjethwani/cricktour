							...
							<fieldset>
								...
								<?php $error = ''; if(form_error('name')){ $error = 'error'; } ?>
							   	...
							   	<div class="control-group formSep row <?php echo $error; ?>">
							        ...
							        <div class="controls col-md-10">
										<input type="text" name="name" id="name" value="<?php echo set_value('name',$tournaments_records->name); ?>" class="input-xlarge form-control"  >
							   	...
							   	<div class="control-group formSep row <?php echo $error; ?>">
							        ...
							        <div class="controls col-md-10">
										<?php
											...
											if($tournaments_records->city_id=='1'){ $one_selected = TRUE; }

											$two_selected = FALSE;

											if($tournaments_records->city_id=='2'){ $two_selected = TRUE; }
										?>
									    <select name="city_id" id="city_id" class="input-xlarge form-control chosen">
							                <option value="">Select City</option>
							 				<option value="1" <?php echo set_select('city_id', '1', $one_selected); ?> >Jaipur</option>
							 				<option value="2" <?php echo set_select('city_id', '2', $two_selected); ?> >Ajmer</option>
									    </select>
								...
								<?php $error = ''; if(form_error('ground_id')){ $error = 'error'; } ?>
							   	...
							   	<div class="control-group formSep row <?php echo $error; ?>">
							        ...
							        <div class="controls col-md-10">
										<input type="text" name="ground_id" id="ground_id" value="<?php echo set_value('ground_id',$tournaments_records->ground_id); ?>" class="input-xlarge form-control"  >
								...
								<?php $error = ''; if(form_error('organiser_name')){ $error = 'error'; } ?>
							   	...
							   	<div class="control-group formSep row <?php echo $error; ?>">
							        ...
							        <div class="controls col-md-10">
										<input type="text" name="organiser_name" id="organiser_name" value="<?php echo set_value('organiser_name',$tournaments_records->organiser_name); ?>" class="input-xlarge form-control"  >
								...
								<?php $error = ''; if(form_error('organiser_mobile_number')){ $error = 'error'; } ?>
							   	...
							   	<div class="control-group formSep row <?php echo $error; ?>">
							        ...
							        <div class="controls col-md-10">
										<input type="text" name="organiser_mobile_number" id="organiser_mobile_number" value="<?php echo set_value('organiser_mobile_number',$tournaments_records->organiser_mobile_number); ?>" class="input-xlarge form-control"  >
							   	...
							   	<div class="control-group formSep row <?php echo $error; ?>">
							        ...
							        <div class="controls col-md-10">
										<div class="input-append date form_date" data-date-format="dd-mm-yyyy">
											<input class="input-xlarge form-control" type="text" name="start_date" id="start_date" value="<?php echo set_value('start_date',prepare_php_date($tournaments_records->start_date)); ?>" /><span class="add-on"><i class="icon-calendar"></i></span>
										</div>
								...
								<?php $error = ''; if(form_error('end_date')){ $error = 'error'; } ?>
							   	...
							   	<div class="control-group formSep row <?php echo $error; ?>">
							        ...
							        <div class="controls col-md-10">
										<div class="input-append date form_date" data-date-format="dd-mm-yyyy">
											<input class="input-xlarge form-control" type="text" name="end_date" id="end_date" value="<?php echo set_value('end_date',prepare_php_date($tournaments_records->end_date)); ?>" /><span class="add-on"><i class="icon-calendar"></i></span>
										</div>
							   	...
							   	<div class="control-group formSep row <?php echo $error; ?>">
							        ...
							        <div class="controls col-md-10">
										<?php
											...
											if($tournaments_records->tournament_category=='0'){ $zero_selected = TRUE; }

											$one_selected = FALSE;

											if($tournaments_records->tournament_category=='1'){ $one_selected = TRUE; }

											$two_selected = FALSE;

											if($tournaments_records->tournament_category=='2'){ $two_selected = TRUE; }

											$three_selected = FALSE;

											if($tournaments_records->tournament_category=='3'){ $three_selected = TRUE; }

											$four_selected = FALSE;

											if($tournaments_records->tournament_category=='4'){ $four_selected = TRUE; }

											$five_selected = FALSE;

											if($tournaments_records->tournament_category=='5'){ $five_selected = TRUE; }
										?>
									    <select name="tournament_category" id="tournament_category" class="input-xlarge form-control chosen">
							                <option value="">Select Tournament Category</option>
							 				<option value="0" <?php echo set_select('tournament_category', '0', $zero_selected); ?> >Open</option>
							 				<option value="1" <?php echo set_select('tournament_category', '1', $one_selected); ?> >Corporate</option>
							 				<option value="2" <?php echo set_select('tournament_category', '2', $two_selected); ?> >Community</option>
							 				<option value="3" <?php echo set_select('tournament_category', '3', $three_selected); ?> >School</option>
							 				<option value="4" <?php echo set_select('tournament_category', '4', $four_selected); ?> >Box-Cricket</option>
							 				<option value="5" <?php echo set_select('tournament_category', '5', $five_selected); ?> >Other</option>
									    </select>
							   	...
							   	<div class="control-group formSep row <?php echo $error; ?>">
							        ...
							        <div class="controls col-md-10">
										<?php
											...
											if($tournaments_records->ball_type=='0'){ $zero_selected = TRUE; }

											$one_selected = FALSE;

											if($tournaments_records->ball_type=='1'){ $one_selected = TRUE; }
									    ...
									    <select name="ball_type" id="ball_type" class="input-xlarge form-control chosen">
							                <option value="">Select Ball Type</option>
							 				<option value="0" <?php echo set_select('ball_type', '0', $zero_selected); ?> >Leather</option>
							 				<option value="1" <?php echo set_select('ball_type', '1', $one_selected); ?> >Tennis</option>
							 				<option value=" 2" <?php echo set_select('ball_type', ' 2', $two_selected); ?> >Other</option>
									    </select>
							   	...
							   	<div class="control-group formSep row <?php echo $error; ?>">
							        ...
							        <div class="controls col-md-10">
										<?php
											...
											if($tournaments_records->match_type=='0'){ $_0_selected = TRUE; }

											$_1_selected = FALSE;

											if($tournaments_records->match_type=='1'){ $_1_selected = TRUE; }
										?>
									    <select name="match_type" id="match_type" class="input-xlarge form-control chosen">
							                <option value="">Select Match Type</option>
							 				<option value="0" <?php echo set_select('match_type', '0', $_0_selected); ?> >Limited Overs</option>
							 				<option value="1" <?php echo set_select('match_type', '1', $_1_selected); ?> >Test Match</option>
									    </select>
								...
								<?php $error = ''; if(form_error('logo')){ $error = 'error'; } ?>
							   	...
							   	<div class="control-group formSep row <?php echo $error; ?>">
							        ...
							        <div class="controls col-md-10">
										<input type="text" name="logo" id="logo" value="<?php echo set_value('logo',$tournaments_records->logo); ?>" class="input-xlarge form-control"  >
								...
								<?php $error = ''; if(form_error('banner')){ $error = 'error'; } ?>
							   	...
							   	<div class="control-group formSep row <?php echo $error; ?>">
							        ...
							        <div class="controls col-md-10">
										<input type="text" name="banner" id="banner" value="<?php echo set_value('banner',$tournaments_records->banner); ?>" class="input-xlarge form-control"  >
								...
								<?php $error = ''; if(form_error('more_details')){ $error = 'error'; } ?>
							   	...
							   	<div class="control-group form-group formSep row <?php echo $error; ?>">
							        <label for="select01" class="control-label col-md-2">More Details </label>
							        <div class="controls col-md-10">
										<textarea class="span8" rows="5" cols="40" id="more_details" name="more_details form-control"><?php echo set_value('more_details',$tournaments_records->more_details); ?></textarea>
