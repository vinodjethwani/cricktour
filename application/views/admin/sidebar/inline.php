...
<!-- jQuery Knob -->
<script src="<?php echo base_url();?>/assets/admintheme/plugins/jquery-knob/jquery.knob.min.js"></script>
<!-- Sparkline -->
<script src="<?php echo base_url();?>/assets/admintheme/plugins/sparkline/jquery.sparkline.min.js"></script>
<!-- page script -->
<script>
  $(function () {
    /* jQueryKnob */
